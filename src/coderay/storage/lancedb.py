...
class Store:
    ...
    def _try_hybrid_search(
        ...
        try:
            ...
            result: list[dict[Any, Any]] | None = query.limit(top_k).to_list()
            return result
        except Exception:
    ...
    def _vector_search(
        ...
        result: list[dict[Any, Any]] = query.limit(top_k).to_list()
        return result
    ...
    def list_chunks(
        ...
        result: list[dict[str, Any]] = arrow.to_pylist()[:limit]
        return result
