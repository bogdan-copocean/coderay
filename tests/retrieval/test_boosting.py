...
class TestStructuralBooster:
    ...
    def test_src_dir_boosted(self, default_config):
        booster = StructuralBooster.from_config()
        results = [
    ...
    def test_vendor_heavily_penalized(self, default_config):
        booster = StructuralBooster.from_config()
        results = [
    ...
    def test_conftest_penalized(self, default_config):
        booster = StructuralBooster.from_config()
        results = [
    ...
    def test_results_sorted_by_score(self, default_config):
        booster = StructuralBooster.from_config()
        results = [
    ...
    def test_does_not_mutate_input(self, default_config):
        booster = StructuralBooster.from_config()
        results = [self._make_result("tests/test_a.py", 0.5)]
