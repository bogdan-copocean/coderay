...
# Run `make` from the directory that contains .coderay.toml (same as the CLI).
# Index lives in .coderay/ (gitignored).
...
# Optional local overrides (not tracked; define extra targets there)
